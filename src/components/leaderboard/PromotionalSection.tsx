        ...
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            >
              ...
              <FiDownload size={20} className="group-hover:animate-bounce relative z-10" aria-hidden="true" />
              <span className="relative z-10">Download BrowsePing</span>
              <FiArrowRight size={16} className="group-hover:translate-x-1 transition-transform relative z-10" aria-hidden="true" />
            </a>
            ...
            >
              <FiGithub size={20} className="group-hover:rotate-12 transition-transform" aria-hidden="true" />
              <span>View on GitHub</span>
              <FiStar size={16} className="group-hover:scale-125 transition-transform" aria-hidden="true" />
            </a>
          </div>
